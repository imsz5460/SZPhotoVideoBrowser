...
- (void)setupData {
    self.dataSource = @[@"https://download.91playmate.cn/5a2d71209c3250e5f073fcecbcbe7eab.mp4",
                        @"https://video.weixinpu.com.cn/o_1c8n2u77r9vr15o98rj1nuithg9.mp4",
                        ...
                        @"https://download.91playmate.cn/5a2d71209c3250e5f073fcecbcbe7eab.mp4",
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self.dataSource enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        //设置哪些是视频
        if (idx == 0 || idx == 1|| idx == 5|| idx == 8|| idx == 11) {
            photo.isVideo = YES;
        }
//        if (idx == 0 ) {
//            photo.isVideo = YES;
